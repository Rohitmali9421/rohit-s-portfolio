...
function Project() {
    return (
        <div className='w-full  bg-gradient-to-t from-[#06071b] from-10% via-[#12101d] via-30% to-[#0c0c0c] to-90%py-4 md:py-8'>
            ...
            <ProjectCard Title="Ecommerce Website" GithubLink=" " LiveLink="" Image1="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/0d106a203014177.668fbab8d6608.png" Image2="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/497f28203014177.668fbab8d5e72.png" Image3="https://mir-s3-cdn-cf.behance.net/project_modules/max_1200/a940b8203014177.668fbab8d6d5e.png"/>
